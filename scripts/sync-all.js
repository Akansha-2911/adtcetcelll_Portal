...
const modifiedRelFiles = [
  ...
  'views/partials/navbar-student.ejs',
  ...
  'views/exam/instructions.ejs',
  'controllers/examController.js',
  'middleware/auth.js',
  'public/spvn-logo.png',
  'public/adt-baramati-mark.png',
  'public/adt-baramati-logo.jpeg',
  '.env',
  'utils/cetExam.js',
  'utils/mathFormatter.js',
  'app.js',
  'views/auth/portal-select.ejs',
  ...
  'controllers/uploadTestController.js',
  'views/admin/upload-test.ejs',
  'models/TestUploadSession.js',
  'utils/storagePaths.js',
  'public/math-render.js'
];
